...
{!! csrf_field() !!}    {{-- token --}}
    ...
    <p>
        ...
        <span class="field">
            <input type="text" name="begin" class="form-control datepicker" data-format="{{$default_lang->date_ui}}" placeholder="{{$default_lang->date_ui}}" value="{{date($default_lang->date, strtotime($el->begin))}}" />
        </span>
    </p>
