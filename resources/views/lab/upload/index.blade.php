                ...
                <tr id="item-{{$el->id}}">
                    ...
                    <td class="right">
                        <div class="btn-group btn-group-xs">
                            <button href="javascript:void(0);" class="get-html btn btn-primary" data-route="{{action('Lab\UploadController@edit', array($el->id))}}" data-container="#upload-meta" data-callback="$('#upload-plugin').hide(0)"><i class="fa fa-fw fa-pencil" aria-hidden="true"></i></button>
