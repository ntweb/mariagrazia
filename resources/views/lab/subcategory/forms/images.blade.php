...
{!! csrf_field() !!}    {{-- token --}}
    ...
    <p>
        ...
        <div class="field">
			...
			&nbsp;&nbsp;&nbsp;
            <a href="javascript:void(0);" class="colorRed get-json" data-route="{{action('Lab\SubcategoryController@deleteImg', array($el->id, 'img'))}}"><i class="fa fa-trash-o" aria-hidden="true"></i> delete</a>
            @endif
        </div>
    </p>
