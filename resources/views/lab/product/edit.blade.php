...
@section('content')
    ...
    <div class="tabbedwidget tab-primary">
        <ul>
            ...
            <li id="refresh-tabs-productoptions" class="get-html" data-route="{{action('Lab\ProductoptionController@index')}}?id_product={{$el->id}}" data-container="#tabs-productoptions"><a href="#tabs-productoptions"><i class="fa fa-check-square-o" aria-hidden="true"></i> {{trans('lab.options')}}</a></li>
